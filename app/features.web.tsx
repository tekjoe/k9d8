...
function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    ...
    >
      ...
      <Text role="heading" aria-level={3} style={{ fontSize: 18, fontWeight: '600', color: '#1A1918' }}>
        {title}
      </Text>
...
export default function FeaturesPage() {
  ...
  return (
    <>
      <SEOHead
        title="Features - Dog Park Finder & Playdate Scheduling"
        description="Explore k9d8 features: interactive dog park map, real-time check-ins, playdate scheduling, direct messaging, and dog profiles. Free for iOS & Android."
        url="/features"
      />
